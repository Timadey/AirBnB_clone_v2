...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        if c_params:  # if there are parameters
            ...
            while param != '':  # while there is still a parameter
                ...
                param_value = self.cast_type(param_value)
                # set the params as instance attr
                new_instance.__setattr__(param_key, param_value)
                c_params = c_params[2].partition(' ')
                param = c_params[0]
    ...
    def help_create(self):
        ...
        print("[Parameter syntax]: <key name>=<value>\n")
